(ns dbval.bench.datascript
  (:require
   [dbval.core :as d]
   [dbval.bench.bench :as bench]
...
(defn ^:export -main
  "clj -A:bench -M -m dbval.bench.datascript [--profile] (add-1 | add-5 | ...)*"
  [& args]
  (let [args     (or args ())
...
(comment
  (require 'dbval.bench.datascript :reload-all)
