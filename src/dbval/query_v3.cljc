(ns ^:no-doc dbval.query-v3
  (:require
    ...
    [dbval.parser :as dp #?@(:cljs [:refer [BindColl BindIgnore BindScalar BindTuple
...
(comment
  ...
  (defn bench [name q & args]
    ...
    (perf/minibench (str "NEW " name) (apply dbval.query-v3/q q args))
    nil)

  (do
    #_(require '[dbval.query-v3 :as q] :reload)
