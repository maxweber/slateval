(ns ^:no-doc slateval.query-v3
  (:require
    ...
    [slateval.parser :as dp #?@(:cljs [:refer [BindColl BindIgnore BindScalar BindTuple
...
(comment
  (t/test-ns 'slateval.test.query-v3)
  ...
  (defn bench [name q & args]
    ...
    (perf/minibench (str "NEW " name) (apply slateval.query-v3/q q args))
    nil)

  (do
    #_(require '[slateval.query-v3 :as q] :reload)
